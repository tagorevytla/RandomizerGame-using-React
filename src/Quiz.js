...
class Quiz extends Component {
	...
	renderMessage() {
		if(this.state.correct) {
			return <h3>Good Job! You hit the correct option! Hit the button below to Play Again!</h3>
		} else {
			return <h3>oh you hit wrong answer! Hit the button below to Play Again!</h3>
		}
	}
	play() {
